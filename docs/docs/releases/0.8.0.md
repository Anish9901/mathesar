...
Filters now support grouping conditions with AND/OR logic, enabling you to create complex queries. You can group multiple filter conditions together and combine groups to build sophisticated filtering expressions, such as finding records that match one set of criteria OR another set of criteria.

*Related work:*

[#4808](https://github.com/mathesar-foundation/mathesar/pull/4808 "Implement nested filtering")
