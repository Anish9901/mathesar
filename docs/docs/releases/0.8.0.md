...
Mathesar now supports more expressive and flexible filtering options for tables that can use arbitrary boolean logic. You can group related conditions together and then combine those groups to support extremely precise filters. 
